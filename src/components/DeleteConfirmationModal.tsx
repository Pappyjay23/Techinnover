  ...
  const { isLightMode } = ThemeContextUse();
	...
	return (
		<div
			...
			className='fixed inset-0 z-50 bg-black/60 backdrop-blur-[4px] flex items-center justify-center p-4'>
			<div className={`${isLightMode ? "bg-white": "bg-[#1E1E1E]"} rounded-lg p-6 max-w-sm w-full`}>
